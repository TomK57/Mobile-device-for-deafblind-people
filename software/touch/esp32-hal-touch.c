...
static uint16_t __touchMeasureCycles = 0x2000;  // 220306 Kr double measurement time. appr. 0.5ms -> 1ms  
...
void __touchInit()
{
    ...
    /* 220306 Kr change according to recommendation */
    /* clear bits for DRANGE before setting new value*/
    CLEAR_PERI_REG_MASK(RTC_IO_TOUCH_CFG_REG, RTC_IO_TOUCH_DRANGE_M);
    /* set value to 01 = 1V range */
    SET_PERI_REG_BITS(RTC_IO_TOUCH_CFG_REG, RTC_IO_TOUCH_DRANGE, 1, RTC_IO_TOUCH_DRANGE_S);
    #warning 220306 Kr 
