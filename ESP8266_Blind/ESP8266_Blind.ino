// ESP8266 Mobile-device-for-deafblind-people
// https://github.com/TomK57/Mobile-device-for-deafblind-people
// Settings: Board: Generic ESP8266 Module, Upload Speed 115000, Flash Freq. 80 Mhz, SSL Basic
...
void setup(void) {
  ...
  Serial.println(F("DeafBlind Server Version 0.2 29.03.2022 DHS"));
...
/* OTA in combination mit mDNS not working, exception (28)!  
