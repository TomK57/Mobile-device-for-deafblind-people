...
// or: Settings: Board: WemosS2Mini based on ESP32S2 chip.
// 220810 Kr new version for hardware with low profile keys as input
//           #define touch is comment
//           tick.h input pins 39,37,35,33,18 with pullup, LED_BUILTIN
//           replaced LITTLEFS.h by LittleFS.h and #define LITTLEFS LittleFS, due to compiler errors. Builtin ESP32 library for S2 Mini seeems to be diferent to ESP32 dev module
//           /home/tjk/Schreibtisch/Arduino/libraries/WebSockets/src/WebSocketsServer.cpp: In member function 'WSclient_t* WebSocketsServerCore::handleNewClient(WiFiClient*)':
//           /home/tjk/Schreibtisch/Arduino/libraries/WebSockets/src/WebSocketsServer.cpp:634:12: warning: function may return address of local variable [-Wreturn-local-addr]
// 220902 Kr ESP32_BLIND_wemoss2minispeaker_1, new version of ESP32_BLIND for breadboard with speakers
//           Input pins 1,2,4,6,8 defined but not used
//           Output pins 37, 35, 33, 18, 16 for speakers
//           pulse duration set to 1ms, tick.h and ap.cfg
// 220906 Kr ESP32_BLIND_wemoss2minilra_1, new version for breadboard with LRAs. Same pin configuration as above.
//           Based on previous experiments it is not necessary to have a complex control scheme for the LRAs. It is sufficient to generate a single pulse.
//           Maybe it is necessary to generate a PWM to reduce the voltage.
//
//regular Libraries
#include <time.h>
...
//#endif
  ...
  //  pinMode(LED_BUILTIN, OUTPUT); TODO war auf den falschen IO pin gesetzt 
